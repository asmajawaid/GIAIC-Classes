...
let lastName = "asma"; //string
let experiance = 32; //number
let married = true; //boolean
let randomValue = "https://www.linkdin.com.in/ameen-alam"; //any
...
let FirstName0 = "jawaid";
let LastName0 = "iqbal";
let fullName0 = `${FirstName0} ${LastName0}`;
