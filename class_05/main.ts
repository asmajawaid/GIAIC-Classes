...
function sum0(num1:number, num2:number){       //num1 parameter he
...
function pro0(num1:number, num2:number){       //num1 parameter he ye parameter he
    let answer = num1 - num2;
    return answer;
}
...
function greeting11 (message:string){
    return message;
}
